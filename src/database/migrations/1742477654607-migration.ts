...
export class Migration1742477654607 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Tasks" ("Id" uuid NOT NULL DEFAULT uuid_generate_v4(), "Title" character varying NOT NULL, "IsDone" boolean NOT NULL, "UserId" uuid NOT NULL, CONSTRAINT "PK_589c709bd92536b13a96d7e2321" PRIMARY KEY ("Id"))`);
